...
using ClimateMachine.Spectra:
    compute_gaussian!,
    compute_legendre!,
    power_spectrum_gcm_1d,
    power_spectrum_gcm_2d,
    SpectralSphericalMesh,
    trans_grid_to_spherical!,
    compute_wave_numbers
using FFTW

include("spherical_helper_additional_for_testing.jl")

FT = Float64
# -- TEST 1: power_spectrum_gcm_1d( var_grid, z, lat, lon, weight )
nlats = 32
...
nm_spectrum, wave_numbers =
    power_spectrum_gcm_1d(var_grid, z, yarray, xarray, mass_weight);
