...
"""
    power_spectrum_gcm_1d( var_grid, z, lat, lon, weight )
...
function power_spectrum_gcm_1d(var_grid, z, lat, lon, weight)
...
"""
    power_spectrum_gcm_2d(u, v, w, L, dim, nor)
...
function power_spectrum_gcm_2d(var_grid, mass_weight)
